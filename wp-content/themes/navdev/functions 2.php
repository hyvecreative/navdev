...
function custom_excerpt($text) {  // custom 'read more' link
   if (strpos($text, '[...]')) {
      ...
      $excerpt = '' . strip_tags($text) . '&nbsp;<a href="'.get_permalink().'" class="readmore">Read more <i class="fas fa-arrow-right i-small"></i></a>';
   }
   return $excerpt;
}
...
if(function_exists('acf_add_options_page')) { 
	...
	acf_add_options_sub_page('Collection Statment');
	acf_add_options_sub_page('Footer');
    acf_add_options_sub_page('Live Updates');
	acf_add_options_sub_page('Club Locations Intro');
	acf_add_options_sub_page('Share your Story');
}

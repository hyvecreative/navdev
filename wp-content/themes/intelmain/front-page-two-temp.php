<?php
/*
Template Name: front_page_two_temp
*/
?>
<?php get_header(); ?>
...
<div id="Services" class="container-fluid services_bg">
 ...
 <a href="#">More <i class="fas fa-arrow-right" aria-hidden="true"></i></a></p>
			</div>
			...
			<div class="col-sm-12 col-md-8 offset-md-2" style="margin-bottom: 30px;">
				...
				<div class="row services-items services-items_top">
					...
					<div class="col-sm-6 service-item-wrap">
						...
						<a href="/metering-services/"><h3>Commercial and Industrial</h3></a>
				...
				<div class="row services-items services-items_middle">
					...
					<div class="col-sm-6 service-item-wrap">
						<a href="/metering-services/"><img src="<?php bloginfo('template_directory'); ?>/images/data.svg" alt="Gas and water icon" /></a>
						<a href="/metering-services/"><h3>Data Insight</h3></a>
				...
				<div class="row services-items services-items_bottom">
					<div class="col-sm-6 service-item-wrap">
						<a href="/metering-services/"><img src="<?php bloginfo('template_directory'); ?>/images/connections.svg" alt="Embedded networks icon" /></a>
						<a href="/metering-services/"><h3>New connections</h3></a>

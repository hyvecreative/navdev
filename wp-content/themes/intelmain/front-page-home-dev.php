<?php
/*
Template Name: front_page_home_dev
*/
?>
<?php get_header(); ?>
...
<div class="row first-pic">
	...
	<div class="hm-pic-wrap hm-breakout"><?php the_post_thumbnail( 'full' ); ?></div>

	<div class="hm-feature-text hm-breakout-text">
...
<!-- begin content -->
	...
	<div id="quick-links" class="container-fluid quick-links quicklinks-row">
		...
		<div class="row">
			...
			<div class="col-lg-4" style="margin-bottom: 2rem; display: flex;">
				...
				<div class="quick-link-wrap">
					...
					<p style="margin-bottom: .5rem">We are an independent metering services provider, offering Metering Coordinator, Metering Provider and Metering Data Provider services.</p>
					<p class="ql-btn text-left"  style="margin-top: 0"> <a class="btn hm-more" href="/about-intellihub/">Find out more <i class="fas fa-arrow-right" aria-hidden="true"></i></a></p>				
				</div>
			...
			<div class="col-lg-4" style="margin-bottom: 30px; display: flex;">
				<div class="quick-link-wrap">
					...
					<p class="ql-btn text-left" style="margin-top: 0"> <a class="btn hm-more" href="/metering-services/">Find out more <i class="fas fa-arrow-right" aria-hidden="true"></i></a></p>
			...
			<div class="col-lg-4" style="margin-bottom: 30px; display: flex;">
				<div class="quick-link-wrap">
					...
					<p class="ql-btn text-left"  style="margin-top: 0"> <a class="btn hm-more" href="/our-technology/">Find out more <i class="fas fa-arrow-right" aria-hidden="true"></i></a></p>				
				</div>
	...
	<div id="content" class="container">
		<div class="row">
				...
				<?php endif; ?>
					...
					<a href="/wptest/about/" class="btn hm-more">About us <i class="fas fa-arrow-right bounce-right" aria-hidden="true"></i></a>
